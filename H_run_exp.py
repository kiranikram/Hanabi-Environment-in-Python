...
def run_game(step_count,target_update):
    ...
    while not is_done:
        ...
        print('selecting actions from', player_legal_actions)
    ...
    agent.Agent().end_episode(transitions)
...
def run_one_phase(min_steps, target_update):
    ...
    while step_count < min_steps:
        episode_length, episode_return = run_game(step_count, target_update)
