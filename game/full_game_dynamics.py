...
all_hint_actions = ['1991', '1992', '1993', '3991', '3992', '3993', '2991', '2992', '2993',
                    ...
                    '11993', '8981', '10982', '12983', '8991', '10992', '12993', '13991', '13992', '13993', '13981',
                    '13982', '13983', '14991', '14992', '14993', '14981', '14982', '14983']
...
def add_hints_back(card):
    ...
    if card in reds:
        actions = ['1991', '1992', '1993', '1981', '1982', '1983']
        return actions
    if card in blues:
        actions = ['2991', '2992', '2993', '2981', '2982', '2983']
        return actions
    if card in greens:
        actions = ['3991', '3992', '3993', '3981', '3982', '3983']
        return actions
    if card in whites:
        actions = ['13991', '13992', '13993', '13981', '13982', '13983']
        return actions
...
def add_suit_hints_back(card):
    ...
    if card in ones:
        actions = ['4991', '4992', '4993', '4981', '4982', '4983']
        return actions
    if card in twos:
        actions = ['5991', '5992', '5993', '5981', '5982', '5983']
        return actions
    if card in threes:
        actions = ['6991', '6992', '6993', '6981', '6982', '6983']
        return actions
    if card in fours:
        actions = ['14991', '14992', '14993', '14981', '14982', '14983']
        return actions


def old_transform_inputs(obs_dict, obs_tensor, prev_action, current_player):

    obs_dict_list = list(obs_dict.values())
    obs_dict_keys_list = list(obs_dict.keys())
    print(obs_dict_keys_list)
    ...
    return oc_1, oc_2, oc_3, os_1, os_2, os_3, th_1, th_2, th_3, f_1, f_2, f_3, f_4, i_t, lives, act, cp
