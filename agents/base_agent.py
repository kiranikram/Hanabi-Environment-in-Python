...
import collections
import random
from game import game_evolution
from nets import DRQNet
...
class DIALAgent(object):
    ...
    def __init__(self):
        ...
        self.optimizer = optim.RMSprop(params=self.policy_net.get_params(), lr=0.005, momentum=0.05)
