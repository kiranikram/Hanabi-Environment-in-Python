...
import collections
import random
from game import game_evolution, BU_game_dynamics, permutations, full_game_evolution_3p
from nets import BU_DRQNet, full_BU_DRQNet
...
class Agent(object):
    ...
    def __init__(self):
        ...
        self.policy_net = full_BU_DRQNet.CNet()
        self.target_net = full_BU_DRQNet.CNet()
    ...
    def begin_episode(self, current_player, legal_actions, obs_dict, obs_tensor, hidden, hidden_tar):
        ...
        hidden_t, q_s = self.policy_net(own_c, own_s, th_1, th_2, th_3, f_1, f_2, f_3, f_4, b_u, i_t, lives, hidden,
                                        act,
                                        cp)
        ...
        hidden_tar_t, q_tar_s = self.target_net(own_c, own_s, th_1, th_2, th_3, f_1, f_2, f_3, f_4, b_u, i_t, lives,
                                                hidden_tar, act, cp)
    ...
    def select_action(self, legal_action_arr, qs):
        ...
        legal_action_list = list(full_game_evolution_3p.all_legal_actions)
        qs_list = qs.tolist()
        available_qs = []
    ...
    def step(self, current_player, legal_moves, observation_dict, observation_tensor, prev_action, hidden,
             hidden_tar, bu_msg, train_mode=True):
        hidden_tar_t = 0
        target_q_val = 0
        ...
        hidden_t, q_s = self.policy_net(own_c, own_s, th_1, th_2, th_3, f_1, f_2, f_3, f_4, bu_msg, i_t, lives, hidden,
                                        act, cp)
        ...
        if train_mode:
            # print('training')
            hidden_tar_t, target_q_s = self.target_net(own_c, own_s, th_1, th_2, th_3, f_1, f_2, f_3, f_4, bu_msg, i_t,
                                                       lives,
                                                       hidden_tar, act, cp)
