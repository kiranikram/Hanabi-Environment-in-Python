...
class CNet(nn.Module):
    ...
    def forward(self,own_c, own_s,th_1,th_2,th_3,  f_1, f_2, f_3,f_4, b_u, i_t, lives, hidden, prev_action, agent):
        """
        ...
        b_u = Variable(torch.LongTensor(b_u))
